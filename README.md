The script is used to help pentesters to orgnize and idenitify the wordlist. it help the users with more than 20 functionality such as removing, inserting, and replacing functions. I find the difficulty in finding a bash tool to create and control a targeted wordlist. I found some solutions in embeded tools such as burpsuite, but we like to deal with the terminal as a linux pros. It was so difficult to write this code, the lines exceeded 1000 reflecting the difficulty of mixing between the program effectiveness, and the users experience. This tool still needs to community help to imporoce its functionalty.

I find some issues in this code, such verbose service, and statistcals mode function wherease it requires a long time when processing a wordlist that contains more that 20000 words. I encourage anyone to imporve the script under the GNU General Public License regarding the version(-v) content. I will be happy to send me on my email hackersforh@gmail.com requesting any helo, any found bugs, or to enhance the script.                                                           Mano-H
